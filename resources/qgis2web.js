...
map.getView().fit([8677292.033012, 653559.136936, 9340126.029706, 1137904.162244], map.getSize());
    ...
    element: (() => {
        ...
        if (71 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This web map shows main transportation links and water ways in SriLanka';
            }
